...
no-op; it never sends a second ready command. Select the transition from a
fresh live preflight under the receipt lock so a concurrent publisher or draft
change cannot reuse stale readiness state.
