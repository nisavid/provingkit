...
`interacting-with-pr-review-feedback` for review-thread replies, and
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| github-markdown-content | - | workflow | coordinate | valid GFM and exact candidate body bytes only | public-skill | writing-github-issue-and-pr-markdown | skills/writing-github-issue-and-pr-markdown/SKILL.md | writing-github-issue-and-pr-markdown |
