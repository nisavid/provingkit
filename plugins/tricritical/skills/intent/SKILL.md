---
name: intent
description: Use when reviewing a candidate for requirement fit, missing outcomes, scope, authority, acceptance criteria, or alternate user and operator perspectives.
---
...
- **Findings**: only high-conviction findings with evidence, affected contract, impact, and smallest direction
- **Falsification attempts**: concrete alternate framings and disproof attempts that the candidate survived; keep these as non-findings and record the evidence tested
