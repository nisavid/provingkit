...
class NavigationIntegrityTests(unittest.TestCase):
    ...
    def test_rejects_non_exact_style_and_extra_shield(self) -> None:
        ...
        self.assertTrue(
            any(
                "ordered approved query" in error
                for error in MODULE.validate(wrong_style)
            )
        )
