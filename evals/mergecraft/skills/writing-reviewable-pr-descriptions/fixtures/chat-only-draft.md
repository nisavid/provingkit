...
- `src/retry_ledger.py`: modified; records retry attempts and exposes the
  exhausted state; 42 implementation additions and 3 implementation deletions.
- `tests/test_retry_ledger.py`: added; covers attempt recording and exhaustion;
  35 test additions and 0 deletions.
- One added and one modified file. No removed, moved, copied, or binary files.
